...
public class GuiRootHud extends GuiElement {
    ...
    public void draw(PoseStack poseStack, GuiGraphicsExtractor graphics, Vec3 proj, BlockHitResult rayTrace, VoxelShape shape) {
        BlockPos blockPos = rayTrace.getBlockPos();
        Vec3 hitVec = rayTrace.getLocation();

        draw(poseStack, graphics, blockPos.getX() - proj.x, blockPos.getY() - proj.y, blockPos.getZ() - proj.z,
                hitVec.x - blockPos.getX(), hitVec.y - blockPos.getY(), hitVec.z - blockPos.getZ(),
                rayTrace.getDirection(), shape.bounds());
    }

    public void draw(PoseStack poseStack, GuiGraphicsExtractor graphics, double x, double y, double z, double hitX, double hitY, double hitZ, Direction facing, AABB boundingBox) {
        ...
        Vec3 magicOffset = facing.getUnitVec3().scale(0.0020000000949949026D);
        poseStack.translate(magicOffset.x(), magicOffset.y(), magicOffset.z());
        ...
        switch (facing) {
            case NORTH:
                ...
                poseStack.translate(boundingBox.maxX, boundingBox.maxY, boundingBox.minZ);
            ...
            case SOUTH:
                ...
                poseStack.translate(boundingBox.minX, boundingBox.maxY, boundingBox.maxZ);
                break;
            case EAST:
                ...
                poseStack.translate(boundingBox.maxX, boundingBox.maxY, boundingBox.maxZ);
            ...
            case WEST:
                ...
                poseStack.translate(boundingBox.minX, boundingBox.maxY, boundingBox.minZ);
                poseStack.mulPose(Axis.YP.rotationDegrees(-90));
                break;
            case UP:
                mouseX = (int) ( ( boundingBox.maxX - hitX ) * size );
            ...
            case DOWN:
                ...
                poseStack.translate(boundingBox.minX, boundingBox.minY, boundingBox.maxZ);
                poseStack.mulPose(Axis.XP.rotationDegrees(90));
                break;
        }

        poseStack.scale(1 / size, -1 / size, 1 / size);
        poseStack.translate(0.0D, 0, 0.02);
